...
// The main content is in /src/app/[lang]/services/page.tsx
...
export default function ServicesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-16 text-center">
      ...
      <Link href={`/${defaultLang}/services`} className="text-primary hover:underline">
        Go to Arabic Services Page
      </Link>
      <br />
      <Link href={`/en/services`} className="text-primary hover:underline">
        Go to English Services Page
      </Link>
    </div>
  );
}
